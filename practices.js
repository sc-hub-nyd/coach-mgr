            ...
            const actionBtns = `
                <div class="c-practice-card__actions">
                    ...
                    <button type="button" class="c-button btn c-button--secondary btn-secondary btn-xs btn-edit-practice" data-id="${p.id}" title="練習情報を編集" aria-label="練習情報を編集">
                        <i class="ti ti-pencil" aria-hidden="true"></i><span>編集</span>
                    </button>
                    <button type="button" class="c-button btn c-button--danger btn-danger btn-xs btn-delete-practice" data-id="${p.id}" title="練習を削除" aria-label="練習を削除">
                        <i class="ti ti-trash" aria-hidden="true"></i><span>削除</span>
                    </button>` : ''}
                </div>
            `;
                                        ...
                                        <li class="c-content-disclosure-list__item">
                                            <details class="c-content-disclosure c-content-disclosure--menu">
                                                ...
                                                <div class="c-content-disclosure__body c-content-disclosure__body--menu">
                                                    ...
                                                    ${menu.videoUrl ? `<div><strong><i class="c-tabler-icon--brand ti ti-brand-youtube"></i> 参考動画</strong><div class="c-content-disclosure__text"><a class="c-content-disclosure__link" href="${escapeHtml(menu.videoUrl)}" target="_blank" rel="noopener noreferrer"><i class="c-tabler-icon--meta ti ti-external-link"></i> 参考動画を見る (YouTube)</a></div></div>` : ''}
