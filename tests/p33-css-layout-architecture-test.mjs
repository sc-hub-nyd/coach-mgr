...
assert.match(source.components, /\.c-metric-grid/);
assert.match(source.components, /\.c-metric--inline/);
assert.match(source.components, /\.c-metric__value/);
...
assert.match(source.systemComponents, /\.c-data-list__actions/);
assert.match(source.systemComponents, /\.c-data-list--scrollable/);
...
assert.match(source.index, /settings-tabs/);
...
assert.match(source.components, /c-liquid-panel/);
assert.match(source.components, /c-liquid-panel--immersive/);
assert.match(source.components, /c-glass-surface--spotlight/);
assert.match(source.components, /c-text-effect--liquid/);
assert.match(source.components, /c-kinetic-kicker--reveal/);
assert.match(source.components, /prefers-reduced-motion: no-preference/);
assert.match(source.components, /data-reduce-motion/);
...
assert.match(source.surfaceDesign, /Kinetic Typography/);
assert.match(source.surfaceDesign, /c-text-effect--liquid/);
