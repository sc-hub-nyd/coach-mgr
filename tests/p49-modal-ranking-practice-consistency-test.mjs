...
requireAll(serviceWorker, ["const CACHE_VERSION = 'coachmgr-v246';", './CSS/components.css', './CSS/components-system.css', './canvas-palette.js', './pitch-renderer.js'], 'R1〜R6 PWA資産');
