                ...
                <div class="c-library-card c-card card" >
                    ...
                    <details class="c-content-disclosure c-content-disclosure--soft" >
                        ...
                        <div class="c-content-disclosure__body"  onclick="event.stopPropagation();">
                            ...
                            ${m.videoUrl ? `<div><strong class="c-content-disclosure__label" ><i class="c-tabler-icon--brand ti ti-brand-youtube" ></i> 参考動画</strong><div class="c-content-disclosure__text" ><a class="c-content-disclosure__link" href="${escapeHtml(m.videoUrl)}" target="_blank" rel="noopener noreferrer" ><i class="c-tabler-icon--meta ti ti-external-link" ></i> 参考動画を見る (YouTube)</a></div></div>` : ''}
