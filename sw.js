...
const CACHE_VERSION = 'coachmgr-v275';
...
const PRECACHE_URLS = [
  ...
  './player-timeline-service.js',
  './player-timeline-ui-state-service.js',
  './player-experience-service.js',
  ...
  './CSS/icon-system.css',
  './assets/vendor/tabler-icons/tabler-icons-subset.css',
  './assets/vendor/tabler-icons/fonts/tabler-icons-subset.woff2',
  './CSS/utilities.css',
  './CSS/dashboard.css',
  './CSS/drawing.css',
  './CSS/tactical.css',
